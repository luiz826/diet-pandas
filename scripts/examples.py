...
def example_3_aggressive_mode():
    ...
    print(f"Safe mode sum: {safe_sum:.2f} (error: {abs(original_sum-safe_sum)/original_sum*100:.4f}%)")
    print(f"Keto mode sum: {keto_sum:.2f} (error: {abs(original_sum-keto_sum)/original_sum*100:.4f}%)")
